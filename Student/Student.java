...
public class Student {
    ...
    private void initialize(){
        ...
        registrationController = new RegistrationController();       studentRunningCourseTableView.setItems(registrationController.getDataFromCurrentCourseAndAddToObservableList("SELECT * FROM studentgpa WHERE dbstudentgpaID = '"+ID+"';"));
