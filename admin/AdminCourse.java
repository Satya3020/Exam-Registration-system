    ...
    private void setCourseSaveButtonClick(Event event){
        try{
            ...
            if(isSetCourseAddNewButtonClick){
                int rowsAffected = statement.executeUpdate("insert into `course` (`dbCourseCode`,`dbCourseTitle`,`dbCourseCredit`,`dbCourseSec`) values ('"+                    courseTFCode.getText()+"','"+courseTFTitle.getText()+"','"+courseTFCredit.getText()+"','"+courseTFSec.getText()+"') ;");
            }
                ...
                int rowsAffected = statement.executeUpdate("update course set "+
                        ...
                        "dbCourseSec = '"+courseTFSec.getText()+ "' where dbCourseCode = '"+                      temp+"';");
            }
            connection.close();
            statement.close();
            resultSet.close();
