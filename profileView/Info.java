    ...
    private void setOtherField(){
        try {
            ...
            while (resultSet.next()){
                ...
                cgpa = resultSet.getString("dbStudentCgpa");           vemail=name.substring(0,1)+resultSet.getString("dbStudentLname")+id.substring(3)+"@bs"+department.toLowerCase()+".uiu.ac.bd";
